  ...
  return (
    <div className="flex w-screen justify-evenly items-center text-slate-900 flex-wrap">
      ...
      <div className="flex flex-col gap-3">
        ...
        <button className="bg-slate-300 rounded h-fit px-5 py-2.5" ref={counterButton}>SHIELD</button>
        <button className={`rounded h-fit px-5 py-2.5 ${curveTouched ? "bg-slate-600" : "bg-slate-300"}`} ref={curveButton}>CURVE</button>
      </div>
    </div>
  );
}
